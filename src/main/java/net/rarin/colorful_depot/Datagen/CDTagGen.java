...
//				.addTag(CCPTags.ColorfulBlockTags.COLORFUL_FLUID_HATCHES.tag);
//
//		prov.tag(CCPTags.ColorfulBlockTags.SUPER_LIGHT.tag)
//				.addTag(CCPTags.ColorfulBlockTags.COLORFUL_COPPER_LADDERS.tag)
//				.addTag(CCPTags.ColorfulBlockTags.COLORFUL_COPPER_DOORS.tag)
//				.addTag(CCPTags.ColorfulBlockTags.COLORFUL_COPPER_BARS.tag);
//
